  ...
  <?php }?>
                    ...
                    <div class="share_price_area">
                      <div class="tour_price" >
                        <p style="white-space: nowrap;"><span class="badge rounded-pill text-bg-warning"><strong><?php echo $obj->getCurrency($searchTData->pck_curr);?></strong>
                          <?=$searchTData->pck_price?>
                          /- </span>
                          <?php if($searchTData->pck_foreign_price>0){?>
                          <span class="badge rounded-pill text-bg-primary"><strong><?php echo $obj->getCurrency($searchTData->pck_foreign_curr);?></strong>
                      ...
                      <div class="prefference"> 
                        ...
                        <span class="follow_by"><span class="material-symbols-outlined">
thumb_up
</span><strong id="pck_count_<?=$searchTData->pck_id;?>">
