          ...
          <div class="lt_first_column"> 
            ...
            <div class="single_pack_description">
              <div class="lt_column_sec">
                <div class="mb-3">
                  <div class="input-group copy_coad_sec mb-0">
                    <input type="text" readonly class="form-control" id="myInput" placeholder="Recipient's username" value="<?=FURL?>quick-tour-details?tId=<?php echo $pckD['pck_id'];?>">
                  ...
                  <span class="copy_coad_message">Copy link and share to your other social media site.</span> </div>
              ...
              <div class="rt_column_sec">
                <div class=" p-1 d-flex justify-content-center flex-column">
                  <div class="price_holder"> <?php echo $obj->getCurrency($pckD['pck_curr']);?> <?php echo $pckD['pck_price'];?> /-
                    <?php if($pckD['pck_foreign_price']>0){?>
                    <div class="foreign_price"> <small>For foreign tourist</small> <?php echo $obj->getCurrency($pckD['pck_foreign_curr']);?>
                      <?=$pckD['pck_foreign_price'];?>
                      /- </div>
                    <?php }?>
                  </div>
