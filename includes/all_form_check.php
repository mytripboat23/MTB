...
if (isset($_POST['changePass'])) 
{
	...
	if(isset($_POST['create_new_package']) && $_POST['create_new_package']=='Yes')
	{
		...
		if($obj->get_message("message")=="")
		{
			...
			$pckD['pck_curr']   	= $obj->filter_mysql($_POST['pck_curr']);
			$pckD['pck_price']   	= $obj->filter_mysql($_POST['pck_price']);
			
			$pckD['pck_foreign_curr']   	= $obj->filter_mysql($_POST['pck_foreign_curr']);
			$pckD['pck_foreign_price']   	= $obj->filter_mysql($_POST['pck_fo_price']);
