...
class phpPayPal { 
	...
	*/
	...
	//	LIVE
	// private $API_USERNAME = 'ray_api1.titanenterprises.com';
	//	SANDBOX
	private $API_USERNAME = 'Payments_api1.oralbreeze.com';
	...
	*/
	...
	//	LIVE
	// private $API_PASSWORD = 'BCVLRPKTBU8C85JX';
	//	SANDBOX
	private $API_PASSWORD = 'JMU2MSDUCXVESAB7';
	...
	*/
	...
	//	LIVE
	// private $API_SIGNATURE = 'AFcWxV21C7fd0v3bYYYRCpSSRl31AeiGQs.FVH5G0UXR1JceH7xlav5S';
	//	SANDBOX
	private $API_SIGNATURE = 'AFcWxV21C7fd0v3bYYYRCpSSRl31AXEv0WPePWsnJhbDq97aA1vJN6NU';
	...
	*/
	private $PROXY_HOST = 'proxy.shr.secureserver.net';
	...
	*/
	private function hash_call($methodName, $nvpStr)
	   ...
	   //Set proxy name to PROXY_HOST and port number to PROXY_PORT in constants.php 
		...
		function set_api_parameters($api_uname,$api_pass,$api_sign){
			$this->API_USERNAME=$api_uname;
			$this->API_PASSWORD=$api_pass;
			$this->API_SIGNATURE=$api_sign;
		}
		function get_api_parameters(){
			echo $this->API_USERNAME."<br>";
			echo $this->API_PASSWORD."<br>";
			echo $this->API_SIGNATURE."<br>";
		}
