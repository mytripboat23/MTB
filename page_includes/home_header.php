<div class="mobile_header_logo d-block d-sm-none d-flex justify-content-center py-4 " >
  <div> <a href="<?=FURL;?>"><img src="img/logo.png" alt=""></a> </div>
  <div>
...
<div style="margin-bottom: 140px;" class=" d-block d-sm-none "></div>
<style>
	.mob_login{
		width: 50px;
    height: 50px;
...
<div class="header_bg home_header d-none d-md-block">
  <div class="container">
      ...
      <nav class="menu_area">
        <div class="nav-menus-wrapper">
          <ul class="nav-menu nav-menu_inner align-to-right">
            ...
            <?php }?>
            <?php /*?><?php if(isset($_SESSION['user']['u_login_id']) && $_SESSION['user']['u_login_id']!=""){?>
<li class="drop_class">
  <?php if(isset($_SESSION['user']['u_login_id']) && $_SESSION['user']['u_login_id']!=""){?>
...
<div class="dropdown">
  ...
  <div id="myDropdown" class="dropdown-content">
    ...
    <a href="dashboard" class="prof_drop_sec">
      ...
      <img class="prof_img" src="<?=AVATAR.$uphoto?>"> <?=$userD['user_full_name']?>
