          ...
          <div class="lt_first_column">
		   ...
		   <?php include("page_includes/dash_body_nav.php");?>
            <div class="create_single_pack">
              <h3 class="heading_bold top_none"><?php if(isset($pckD['pck_id']) && $pckD['pck_id']!=''){?> Edit Your Tour Package <?php }else{ ?> Add Your Tour Details <?php }?></h3>
			  ...
			  <?php }?>
				  ...
				  <div class="create_pack_holder row">
							...
							<span class="messages" id="pck_title_message"></span>
							</div>
                  ...
                  <span class="messages" id="pck_dest_message"></span> 
					  </div>
					  <div class="col-md-12 col-lg-3  mb-3 col-4">
						...
						<option value="<?php echo date("n", strtotime("$iM/12/$year"));?>" <?php if($pckD['pck_month'] == date("n", strtotime("$iM/12/$year"))){?>selected<?php }?>><?php echo date("F", strtotime("$iM/12/$year"));?></option>
		                   ...
		                   <span class="messages" id="pck_month_message"></span>
					  </div>
                      ...
                      <span class="messages" id="pck_start_dt_message"></span>
                    ...
                    <span class="messages" id="pck_end_dt_message"></span>
                  ...
                  <span class="messages" id="pck_start_pt_message"></span> 
                  ...
                  <span class="messages" id="pck_end_pt_message"></span> 
                  ...
                  <span class="messages" id="pck_price_message"></span> 
					  </div>
                  ...
                  <div class="number input-group">
					  <span class="minus input-group-text">-</span>
                    ...
                    <span class="plus input-group-text">+</span> 
						  </div>
					  
					    <span class="messages" id="pck_capacity_message"></span>
					  </div>
                      ...
                      <span class="messages" id="pck_start_tm_message"></span>
					  </div>
				  ...
				  <div id="pckupimgs" class="mt-4">
						...
						<div class="col-4"><div class="1st"><button type="button" class="close" onClick="delPckUpImg('<?=$i;?>')"><span>&times;</span></button><img class="w-100" src="<?=PACKAGE;?><?=$_SESSION['pck_photos'][$i];?>"></div></div>
						<?php }?>
						</div>
						<?php }?>
						</div>
			...
			<?php /*?> <li> <a type="button" data-bs-toggle="modal"  href="#custom_box">
