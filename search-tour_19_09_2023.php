                  ...
                  <div class="tour_info">
                    ...
                    <div class="share_price_area">
                      <div class="tour_price">
						...
						<?php if(!isset($_SESSION['user']['u_login_id']) || $_SESSION['user']['u_login_id']=='' ){?>data-bs-title="Login to see the deal price"<?php }?>><span class="material-symbols-outlined">currency_rupee</span>
...
<div class="prefference">
 ...
 <strong>Oops..... </strong>We can't find Your Boat for " <strong><?=$search_dest;?></strong> ".</div>
            <?php }?>
            <?php /*?>
