...
if(isset($_POST['btnDelete']))
{
	if(is_array($_POST['chkSelect']))
	{
		foreach($_POST['chkSelect'] as $chbxAr)
		{
			...
			$deleteStatus = $obj->updateData(TABLE_PACKAGE,array('tour_top'=>'n'),"pck_id='".$chbx."'");
		}
...
if(isset($_POST['add_top_tour']) && $_POST['add_top_tour']!="")
{
...
$sql=$obj->selectData(TABLE_PACKAGE,"","pck_status<>'Deleted' and tour_top='y' ".$extra." order by pck_id desc",2);
    ...
    <div class="page-content">
      ...
      <div class="page-content-area">
        <div class="page-header">
          <h1> Tranding Tour Home Page <small> </h1>
        </div>
        <!-- /.page-header -->
                    ...
                    <div id="custom-search-input">
                      ...
                      <div class="input-group col-md-4">
                       <input type="hidden" name="search_package_hid" id="search_package_hid" class="form-control"  value="<?=$_REQUEST['search_package']?>" />
                        ...
                        <input class="btn btn-info" type="submit" name="add_top_tour" value="Add Top Tour">
                        </span> </div>
                    </div>
                  </form>
                </div>
