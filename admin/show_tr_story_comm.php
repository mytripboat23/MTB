...
if(isset($_POST['btnDelete']))
{
	if(is_array($_POST['chkSelect']))
	{
		foreach($_POST['chkSelect'] as $chbxAr)
		{
			...
			$deleteStatus = $obj->updateData(TABLE_STORY_COMMENT,array('tsc_status'=>'Deleted'),"tsc_id='".$chbx."'");
		}
...
$sql=$obj->selectData(TABLE_STORY_COMMENT,"","tsc_status<>'Deleted'".$extra." order by tsc_id asc",2);
  ...
  <div class="main-content">
    <div class="breadcrumbs" id="breadcrumbs"> 
      ...
      <ul class="breadcrumb">
		...
		<li class="active">Travel Story Comments</li>
      </ul>
      <!-- /.breadcrumb -->
    ...
    <div class="page-content">
      ...
      <div class="page-content-area">
        <div class="page-header">
          <h1> Dashboard <small> <i class="ace-icon fa fa-angle-double-right"></i> <?php /*?>Story Comment Listings <span class="pull-right"><a href="edit_tr_story_comm.php?return_url=<?=urlencode($_SERVER['REQUEST_URI'])?>"><i class="fa fa-plus-square"></i> Add Story Comments </a></span> <?php */?></small> </h1>
        </div>
        <!-- /.page-header -->        
        <div class="row">
          <div class="col-xs-12"> 
  ...
  <form name="form1" method="post" action="<?=$_SERVER['REQUEST_URI']?>" onSubmit="return validate_delete('chkSelect1')">
    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
      ...
      <tbody>
	   ...
	   ?>
        <tr> 
			<td><?=$obj->get_story_title($data['ts_id']);?></td>	
			<td><?=$obj->get_user_full_name($data['user_id']);?></td>
			<td><?=$obj->short_description_cw($data['tsc_comm'],100);?><br><a href="javascript:void(0);" onClick="view_full_comments(<?=$data['tsc_id'];?>)">View Full</a></td>
			
			<td><?=date(DATE_FORMAT, strtotime($data['tsc_added']));?></td>
			<td><?=date(DATE_FORMAT, strtotime($data['tsc_updated']));?></td>
			<?php /*?><td><a href="edit_tr_story_comm.php?tscId=<?=$data['tsc_id'];?>&return_url=<?=urlencode($_SERVER['REQUEST_URI'])?>" class="tooltip-info" data-rel="tooltip" title="View">Edit</a></td><?php */?>	
			<td class="center"><label class="position-relative">             
			<input type="checkbox"  name="chkSelect[]" class="ace" id="chkSelect1" myType="demo" value="<?=$data['tsc_id'];?>" />
