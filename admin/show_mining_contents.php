...
adminSecure(); 
$sql=$obj->selectData(TABLE_CONTENT,"","content_status<>'Deleted' and content_id = '3'".$extra." order by content_id desc",2);
  ...
  <div class="main-content">
    <div class="breadcrumbs" id="breadcrumbs"> 
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">Services CMS</li>
      </ul>
      <!-- /.breadcrumb -->
    ...
    <div class="page-content">
      ...
      <div class="page-content-area">
        <div class="page-header">
          <h1> Dashboard <small> <i class="ace-icon fa fa-angle-double-right"></i>Services Content Management</small> </h1>
        </div>
        <!-- /.page-header -->
    ...
    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
      ...
      <tbody>
        ...
        <tr>         
          ...
          <td><a href="edit_mining_content.php?cId=<?=$data['content_id']?>&return_url=<?=urlencode($_SERVER['REQUEST_URI'])?>" class="tooltip-info" data-rel="tooltip" title="Edit">Edit</a></td>			 
        </tr>
		<?php
		  }
		?>
