...
adminSecure();
$table_caption = "Set Social Links";
if($_POST['SetSocialLinks'])
{
		$arrAE['facebook_link'] 	= $obj->filter_mysql($_POST['facebook_link']);
		$arrAE['set_telegram_link'] = $obj->filter_mysql($_POST['set_telegram_link']);
		$obj->updateData(TABLE_SETTINGS,$arrAE,"set_id='1'");
		$obj->add_message("message","Social Links ".UPDATE_SUCCESSFULL);
              ...
              <div class="col-xs-12">
                <form class="form-horizontal" role="form" name="socialLinks" id="socialLinks" method="post" action="">
				   ...
				   <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="facebook_link" name="facebook_link" placeholder="Facebook" class="col-xs-10 col-sm-5" value="<?=htmlentities($site_set['facebook_link']);?>" validate="required:true" />
                    </div>
                  </div> 
				  
				  <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Telegram:</label>
                    <div class="col-sm-9">
                      <input type="text" id="set_telegram_link" name="set_telegram_link" placeholder="Telegram" class="col-xs-10 col-sm-5" value="<?=htmlentities($site_set['set_telegram_link']);?>" validate="required:true" />
                    </div>
                  </div>
				...
				<div class="form-group">
                  ...
                  <div class="clearfix form-actions">
                    <div class="col-md-offset-3 col-md-9">
                      <input type="submit" name="SetSocialLinks" value="Save" class="btn btn-info">
                      &nbsp; &nbsp; &nbsp; </div>
                  </div>
                </form>
              </div>
