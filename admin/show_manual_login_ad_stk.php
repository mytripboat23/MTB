  ...
  <div class="main-content">
    <div class="breadcrumbs" id="breadcrumbs">
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">Login Ad Stakers Listing</li>
      </ul>
      <!-- /.breadcrumb -->
      <?php /* ?>
    ...
    <div class="page-content">
      <div class="page-content-area">
        <div class="page-header">
          <h1> Dashboard <small> <i class="ace-icon fa fa-angle-double-right"></i> Login Ad Stakers Management </small> </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <div class="col-xs-12">
	   ...
	   ?>
                      <tr>
                        ...
                        <td><?=$data['order_tot_asimi'];?>
                          Asimi</td>
                        <td><?=$data['order_created'];?></td>
                        <td><a href="manual_assign_login_ad_stk.php?oId=<?=$data['order_id']?>&return_url=<?=urlencode($_SERVER['REQUEST_URI'])?>" class="tooltip-info" data-rel="tooltip" title="Assign Slot">ASSIGN</a></td>
                      </tr>
                      <?php
		  }
		  }
