...
if(isset($_POST['btnDelete']))
{
	if(is_array($_POST['chkSelect']))
	{
		foreach($_POST['chkSelect'] as $chbxAr)
		{
			...
			$deleteStatus = $obj->updateData(TABLE_PACKAGE,array('pck_top'=>'n'),"pck_id='".$chbx."'");
		}
...
if(isset($_POST['add_top_package']) && $_POST['add_top_package']=='Add Top Package')
{
	...
	if($obj->get_message("message")=="")
	{
		$topP = array();
		$topP['pck_top'] = 'y';
		$obj->updateData(TABLE_PACKAGE,$topP,"pck_id='".$_POST['search_package_hid']."'");	
		
		$_SESSION['messageClass'] = "successClass";
		$obj->add_message("message","Package added as top package sucecssfully");
		$obj->reDirect($_SERVER['REQUEST_URI']);
	}				
...
$sql=$obj->selectData(TABLE_PACKAGE,"","pck_status<>'Deleted' and pck_top='y' ".$extra." order by pck_id desc",2);
    ...
    <div class="page-content">
      ...
      <div class="page-content-area">
        <div class="page-header">
          <h1> Hot tour and left top pack Listings </h1>
        </div>
        <!-- /.page-header -->
                    ...
                    <div id="custom-search-input">
                      ...
                      <div class="input-group col-md-4">
                       <input type="hidden" name="search_package_hid" id="search_package_hid" class="form-control"  value="<?=$_REQUEST['search_package']?>" />
                        ...
                        <input class="btn btn-info" type="submit" name="add_top_package" value="Add Top Package">
                        </span> </div>
                    </div>
                  </form>
                </div>
...
-->
	  ...
	  <table>
	   <tr>
<!--          <td class="center" colspan="10"><div class="pagination"><?php echo $pg_obj->pageingHTML;?></div></td>-->
