...
<ul class="nav nav-list">
	...
	<li <?php if($curPage=='show_sub_admin.php' || $curPage=='edit_sub_admin.php'){?>class="active"<?php }?>> <a href="show_sub_admin.php"> <i class="menu-icon fa fa-user-secret"></i> <span class="menu-text"> Sub Admin </span> </a> <b class="arrow"></b> </li>
	
	<li <?php if($curPage=='show_sub_admin_pages.php' || $curPage=='edit_sub_admin_pages.php'){?>class="active"<?php }?>> <a href="show_sub_admin_pages.php"> <i class="menu-icon fa fa-user-secret"></i> <span class="menu-text"> Page Permission </span> </a> <b class="arrow"></b> </li>
	
	
	
	<li <?php if($curPage=='show_referred_by.php' || $curPage=='edit_referred_by.php'){?>class="active"<?php }?>> <a href="show_referred_by.php"> <i class="menu-icon fa fa-user-secret"></i> <span class="menu-text"> Referred by </span> </a> <b class="arrow"></b> </li>
 ...
 if($risk_disclaimerA == 1 || $risk_disclaimerB ==1) { 
 ?>
 ...
 <?php } ?>	
	...
	<?php   if($_SESSION['admin']['admin_type'] == 'm') { ?>
	<li <?php if($curPage=='show_email_facility.php' || $curPage=='edit_email_facility.php' || $curPage=='show_send_email.php' || $curPage=='edit_send_email.php'){?>class="active"<?php }?>> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-cubes"></i> <span class="menu-text"> Internal Email </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
	<ul class="submenu">		
 ...
 if($privacyPolicyA == 1 || $privacyPolicyB ==1) { 
 ?>	
	
	<li <?php if($curPage=='show_privacy_policy_contents.php' || $curPage=='edit_privacy_policy_content.php'){?>class="active"<?php }?>> <a href="show_privacy_policy_contents.php"> <i class="menu-icon fa fa-user-secret"></i> <span class="menu-text"> Privacy Policy </span> </a> <b class="arrow"></b> </li>	
 <?php } ?>	
 ...
 <?php } ?>	 
	...
	if($aff_reg == 1) { 
	?>	
		<li <?php if($curPage=='show_affiliate_registration.php'){?>class="active"<?php }?>> <a href="show_affiliate_registration.php"> <i class="menu-icon fa fa-users"></i> <span class="menu-text">  Affiliate Reg. (Paid) </span> </a> <b class="arrow"></b> </li> 
	<?php } ?>
	<?php  
...
<?php */ ?>				
	...
	if($AdsdirectoryA == 1) { 
	?>	
	<li <?php if($curPage=='show_ad_directory_listing.php' || $curPage=='edit_ad_directory_listing.php'){?>class="active"<?php }?>> <a href="show_ad_directory_listing.php"> <i class="menu-icon fa fa-picture-o"></i> <span class="menu-text"> Ad Directory Listing</span> </a> <b class="arrow"></b> </li>
	<?php } ?>
...
/*	
   ...
   <li <?php if($curPage=='exp_members_withdrawal.php' || $curPage=='show_denied_withdrawal.php'){?>class="active"<?php }?>> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-circle"></i> <span class="menu-text"> Withdrawal </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
	...
	if($showtermncond == 1) { 
	?>	
	<li <?php if($curPage=='show_term_condition.php' || $curPage=='show_affiliate_term_condition.php' || $curPage=='edit_term_condition.php' || $curPage=='edit_affiliate_term_condition.php' ){?>class="active"<?php }?>> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-cubes"></i> <span class="menu-text"> Term & Condition  </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
	<ul class="submenu">		
	...
	?>	
	<li <?php if($curPage=='show_minter_credit_reward.php' || $curPage=='edit_minter_credit_reward.php' || $curPage=='show_banner_ad_credit_reward.php' || $curPage=='edit_banner_ad_credit_reward.php' || $curPage=='show_admin_reward.php' || $curPage=='edit_admin_reward.php' || $curPage=='set_joining_reward.php'){?>class="active"<?php }?>> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-chain"></i> <span class="menu-text"> Reward </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
		<ul class="submenu">
			<?php  
	...
	{  
	?>	 
	<li <?php if($curPage=='show_view_to_earn_ads.php' || $curPage=='show_raffle_banner_entry.php' || $curPage=='show_pending_view_to_earn_ads.php' || $curPage=='show_raffle_banner_winner.php' || $curPage=='show_raffle_winner.php' || $curPage=='show_raffle_entry.php'){?>class="active"<?php }?>> <a href="#" class="dropdown-toggle"> <i class="menu-icon fa fa-chain"></i> <span class="menu-text">V2E Ads </span> <b class="arrow fa fa-angle-down"></b> </a> <b class="arrow"></b>
		<ul class="submenu">		
